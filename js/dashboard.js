...
async function showAnswers() {
  ...
  try {
    ...
    // Only show saved quizzes - no current game display
    ...
    // Skip current game - only show saved quizzes from history
...
async function showAllUsersQuizzes() {
  ...
  try {
    ...
    // Only show saved quizzes - skip current game
    let quizList = [];
